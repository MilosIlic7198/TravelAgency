<template>
    <form>
        <div class="row justify-content-sm-center">
            ...
            <div class="col-sm-auto">
                <div class="m-2">
                    ...
                    <input type="text" class="border border-gray-200 rounded p-2" id="forFirstName"
                        placeholder="Enter first name" name="firstName" v-model="policy.holdersFirstName" />
                </div>
                <div class="m-2">
                    <label for="forLastName" class="d-block text-lg">Holders last name:</label>
                    <input type="text" class="border border-gray-200 rounded p-2" id="forLastName"
                        placeholder="Enter last name" name="lastName" v-model="policy.holdersLastName" />
                </div>
                <div class="m-2">
                    <label for="forPhoneNumber" class="d-block text-lg">Holders phone number:</label>
                    <input type="text" class="border border-gray-200 rounded p-2" id="forPhoneNumber"
                        placeholder="Enter phone number" name="phoneNumber" v-model="policy.holdersPhoneNumber" />
                </div>
            </div>
            <div class="col-sm-auto m-2">
                ...
                <textarea class="border border-gray-200 rounded p-2" name="description" rows="5"
                    v-model="policy.description"></textarea>
            </div>
            <div class="col-sm-auto">
                <div class="m-2">
                    <label for="forDateFrom" class="d-block text-lg">Date from:</label>
                    <date-picker type="date" v-model="policy.dateFrom" format="DD.MM.YYYY"></date-picker>
                </div>
                <div class="m-2">
        ...
        <div class="row justify-content-sm-center" v-if="showForm">
            <div class="col-sm-auto" v-for="(participant, index) in policy.participants">
                <div class="m-2">
                    <label for="forParticipant" class="d-block text-lg">Participant first name:</label>
                    <input type="text" class="border border-gray-200 rounded p-2" id="forParticipant"
                        placeholder="Enter first name" name="participantFirstName" v-model="participant.firstName" />
                </div>
                <div class="m-2">
                    <label for="forParticipant" class="d-block text-lg">Participant last name:</label>
                    <input type="text" class="border border-gray-200 rounded p-2" id="forParticipant"
                        placeholder="Enter last name" name="participantLastName" v-model="participant.lastName" />
                </div>
                <div class="m-2">
                    <label for="forParticipant" class="d-block text-lg">Participant birthdate:</label>
                    <date-picker type="date" v-model="participant.birthdate" format="DD.MM.YYYY"></date-picker>
                </div>
                <div class="m-2">
                    <button @click.prevent="remove(index)" class="btn btn-danger btn-sm">
                        Remove
                    </button>
                </div>
            </div>
        ...
        <div class="row justify-content-sm-center">
            <div class="col-sm-auto m-2">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="policyType" id="forIndividual"
                        @change="forIndividual()" :checked="showForm == false" />
                    <label class="form-check-label" for="forIndividual">Individual</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="policyType" id="forGroup" @change="forGroup()" />
