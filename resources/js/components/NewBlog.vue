<template>
    <form>
        ...
        <div class="m-2">
            ...
            <input type="text" class="border border-gray-200 rounded p-2" name="title" v-model="formFields.title" />
        </div>
        <div class="m-2">
        ...
        <select class="border border-gray-200 rounded p-2 m-2" name="type" v-model="formFields.type">
...
export default {
    ...
    methods: {
        ...
        createBlog() {
            if (!this.formFields.title || !this.formFields.description || !this.formFields.image || !this.formFields.type) {
